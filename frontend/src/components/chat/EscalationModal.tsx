...
import { X, Calendar, User, Mail, Clock } from 'lucide-react'
...
export function EscalationModal({ isOpen, onClose, onSubmit, reason }: EscalationModalProps) {
        ...
        <div className="flex items-start justify-between border-b border-[#E5E7EB] px-6 py-5">
          <div>
            ...
            <p className="mt-0.5 text-xs text-[#6B7280]">
              A RelayPay specialist will follow up with you directly.
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="flex flex-col items-center gap-4 px-6 py-10 text-center">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-[#6B7280]">
                Check your email — you'll receive a confirmation with calendar invite.
              </p>
            </div>
            <button
              onClick={onClose}
